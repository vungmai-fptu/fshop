...
<div class="row pageBtn">
    <div class="col" style="text-align: right;">
        <br/>
        <form action="<c:url value="/brand/nokia.do" />">
            <button type="submit" class="btn btn-danger btn-sm btn-info" name="op" value="FirstPage" title="First Page" <c:if test="${pageNokia==1}">disabled</c:if>><i class="bi bi-chevron-bar-left"></i></button>
            <button type="submit" class="btn btn-danger btn-sm btn-info" name="op" value="PreviousPage" title="Previous Page" <c:if test="${pageNokia==1}">disabled</c:if>><i class="bi bi-chevron-left"></i></button>
            <button type="submit" class="btn btn-danger btn-sm btn-info" name="op" value="NextPage" title="Next Page" <c:if test="${pageNokia==totalPageNokia}">disabled</c:if>><i class="bi bi-chevron-right"></i></button>
            <button type="submit" class="btn btn-danger btn-sm btn-info" name="op" value="LastPage" title="Last Page" <c:if test="${pageNokia==totalPageNokia}">disabled</c:if>><i class="bi bi-chevron-bar-right"></i></button>
            <input type="text" name="gotoPage" value="${pageNokia}" class="btn btn-danger btn-sm btn-outline-info" style="text-align: right;color:#fff;width: 32px;" title="Enter page number"/>
